...
Native macOS GUI for [Claude Code](https://docs.anthropic.com/en/docs/claude-code). This is an MVP.
...
This codebase was fully generated by [Claude Code](https://docs.anthropic.com/en/docs/claude-code) itself.
